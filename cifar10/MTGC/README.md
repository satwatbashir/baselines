...
- **Model:** CIFAR-10 CNN from the MTGC paper (2× conv-5 64ch + FC 384/192/10, ~890K params)
...
These defaults match the MTGC paper's CIFAR-10 setup. Override with CLI flags.

## Run
```bash
cd Chapter3-Baselines/cifar10/MTGC
